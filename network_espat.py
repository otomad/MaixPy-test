...
class wifi():
    ...
    def init():
        ...
        fm.register(2, fm.fpioa.GPIOHS0) # board_info.WIFI_EN == IO 8
        __class__.en = GPIO(GPIO.GPIOHS0,GPIO.OUT)

        fm.register(14,fm.fpioa.UART2_TX) # board_info.WIFI_RX == IO 7
        fm.register(13,fm.fpioa.UART2_RX) # board_info.WIFI_TX == IO 6
